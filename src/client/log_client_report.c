/******************************************************************************
*
*  FILE NAME   : log_client_report.c
*
*  DESCRIPTION : this file contails function to generate log report file for client
*
...
/******************************************************************************
 *	FUNCTION NAME	: log_client_report.
 *
 *	DESCRIPTION	: function to generate log report file for client
 *
 *	RETURNS 	: nothing

*******************************************************************************/

void log_client_report( 
				int type,		/* log level */
